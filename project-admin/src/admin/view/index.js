...
import zysoft from '../../assets/img/avatar.jpg';
import '../index.less';
                        ...
                        <Col md={8}>
                            <Card bodyStyle={{padding: 0}}>
                                <div className='avatar'>
                                    ...
                                    />
                                    <p>startcaft</p>
                                    <p>startcaft@163.com</p>
                                </div>
                                <div className='weather'>
                                    {/*心知天气API*/}
                                    <div className='weather-img'>
                                        <img src={require('../../assets/img/0.png')} alt=""/>
                                    </div>
                                    <div className='weather-info'>
                                        <span>武汉</span>&nbsp;<span>36℃</span>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <div className='pro'>
                                    ...
                                    <Row gutter={16}>
                                        ...
                                        <Col span={12}>
                                            <p>MSPA</p>
                                            <Progress type="dashboard" percent={100} width={125} format={() => 'Done'}
                                                      id='pro4'/>
                                        </Col>
                                    </Row>
                                </div>
